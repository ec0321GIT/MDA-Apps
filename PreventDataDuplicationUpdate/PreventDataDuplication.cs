        ...
        protected override void ExecuteDataversePlugin(ILocalPluginContext localPluginContext)
        {
            ...
            if (IsValidTargetEntity(context, out Entity entity))
            {
                ...
                if (context.MessageName.Equals("Update", StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    var recordId = entity.Attributes[Constants.AccountMappingId] as Guid?;
                    localPluginContext.TracingService.Trace("Record ID: {0}", recordId.HasValue ? recordId.Value.ToString() : "null");
